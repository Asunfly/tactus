...
const COVERED_BROWSER_TOOLS: ToolScenario[] = [
  ...
  { toolName: 'browser_handle_dialog', args: { accept: true }, requiresConfirmation: true },
  ...
  { toolName: 'browser_run_code', args: { code: 'async (page) => await page.title()' }, requiresConfirmation: true },
...
function createHarness(scenario: ToolScenario) {
  ...
  return {
    ...
    input: {
      ...
      updateLogEntry: () => {},
      buildAutomationDetail: (detail: string) => detail,
      requestAutomationConfirmation,
